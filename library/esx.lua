...
---[shared]
function keybind_mt:disable(toggle) end

---[shared]
function keybind_mt:getCurrentKey() end

---[shared]
function keybind_mt:isControlPressed() end

---[shared]
function keybind_mt:remove() end

---[shared]
function medal.getConfig() end

---[shared]
function medal.triggerClip(publicKey, eventName, clipOptions) end

---[client]
function menu.close() end

---[client]
function menu.refresh() end

---[client]
function menu.removeElement(query) end

---[client]
function menu.setElement(i, key, val) end

---[client]
function menu.setElements(newElements) end

---[client]
function menu.setTitle(val) end

---[client]
function menu.update(query, newData) end
...
function pubsub.clear(topic) end

---[shared]
---@param src number
---@param topic string
---@return boolean
function pubsub.isSubscribed(src, topic) end

---[shared]
---Remove handlers for a topic. Without a handler argument, removes all of them.
---@param topic string
---@param handler? function
function pubsub.off(topic, handler) end

---[shared]
---Register a handler for a topic. Multiple handlers per topic are allowed.
---@param topic string
---@param handler fun(data: any, topic: string)
function pubsub.on(topic, handler) end

---[shared]
---@param topic string
---@param data any server-trusted data only
---@return integer count number of players notified
function pubsub.publish(topic, data) end

---[shared]
---@param src number serverId of the player to add
---@param topic string
---@return boolean added
function pubsub.subscribe(src, topic) end

---[shared]
---@param topic string
---@return number[] serverIds
function pubsub.subscribers(topic) end

---[shared]
---@param src number
---@param topic string
---@return boolean removed
function pubsub.unsubscribe(src, topic) end

---[server]
function self.addAccountMoney(accountName, money, reason) end

---[server]
function self.addInventoryItem(itemName, count) end

---[server]
function self.addMoney(money, reason) end

---[server]
function self.addWeapon(weaponName, ammo) end

---[server]
function self.addWeaponAmmo(weaponName, ammoCount) end

---[server]
function self.addWeaponComponent(weaponName, weaponComponent) end

---[server]
function self.canCarryItem(itemName, count) end

---[server]
function self.canSwapItem(firstItem, firstItemCount, testItem, testItemCount) end

---[server]
function self.clearMeta(index, subValues) end

---[server]
function self.executeCommand(command) end

---[server]
function self.get(k) end

---[server]
function self.getAccount(account) end

---[server]
function self.getAccounts(minimal) end

---[server]
function self.getCoords(vector, heading) end

---[server]
function self.getGroup() end

---[server]
function self.getIdentifier() end

---[server]
function self.getInventory(minimal) end

---[server]
function self.getInventoryItem(itemName) end

---[server]
function self.getJob() end

---[server]
function self.getLoadout(minimal) end

---[server]
function self.getMaxWeight() end

---[server]
function self.getMeta(index, subIndex) end

---[server]
function self.getMoney() end

---[server]
function self.getName() end

---[server]
function self.getPlayTime() end

---[server]
function self.getSSN() end

---[server]
function self.getSource() end

---[server]
function self.getWeapon(weaponName) end

---[server]
function self.getWeaponTint(weaponName) end

---[server]
function self.getWeight() end

---[server]
function self.hasItem(item) end

---[server]
function self.hasWeapon(weaponName) end

---[server]
function self.hasWeaponComponent(weaponName, weaponComponent) end

---[server]
function self.isAdmin() end

---[server]
function self.isPaycheckEnabled() end

---[server]
function self.kick(reason) end

---[server]
function self.removeAccountMoney(accountName, money, reason) end

---[server]
function self.removeInventoryItem(itemName, count) end

---[server]
function self.removeMoney(money, reason) end

---[server]
function self.removeWeapon(weaponName) end

---[server]
function self.removeWeaponAmmo(weaponName, ammoCount) end

---[server]
function self.removeWeaponComponent(weaponName, weaponComponent) end

---[server]
function self.set(k, v) end

---[server]
function self.setAccountMoney(accountName, money, reason) end

---[server]
function self.setCoords(coordinates) end

---[server]
function self.setGroup(newGroup) end

---[server]
function self.setInventoryItem(itemName, count) end

---[server]
function self.setJob(newJob, grade, onDuty) end

---[server]
function self.setMaxWeight(newWeight) end

---[server]
function self.setMeta(index, value, subValue) end

---[server]
function self.setMoney(money) end

---[server]
function self.setName(newName) end

---[server]
function self.setWeaponTint(weaponName, weaponTintIndex) end

---[server]
function self.showAdvancedNotification(sender, subject, msg, textureDict, iconType, flash, saveToBrief, hudColorIndex) end

---[server]
function self.showHelpNotification(msg, thisFrame, beep, duration) end

---[server]
function self.showNotification(msg, notifyType, length, title, position) end

---[server]
function self.togglePaycheck(toggle) end

---[server]
function self.triggerEvent(eventName, ...) end

---[server]
function self.updateWeaponAmmo(weaponName, ammoCount) end
