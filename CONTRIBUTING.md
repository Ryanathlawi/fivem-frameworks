...
الاستثناء الوحيد `library/cfx_manifest.lua`: مفردات ثابتة من مرجع Cfx.re
لتوجيهات `fxmanifest.lua`، لا تُستخرج من أي مستودع فتُحرَّر يدويًا. بدونها
يمتلئ كل `fxmanifest.lua` بتحذيرات `undefined-global`.
